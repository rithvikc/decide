class ResultsController < ApplicationController
  ...
  def zomato_api_call(geo_center, cuisine)
    ...
    'https://developers.zomato.com/api/v2.1/search?lat=#{geo_center[:latitude]}&lon=#{geo_center[:longitude]}&&cuisines=#{cuisine}&radius=500&sort=real_distance&order=asc&start=0&count=5' \
--header 'user-key: {{Zomato API Key}}'
